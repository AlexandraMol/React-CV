...
import { BookIcon } from 'evergreen-ui';
  ...
  render() {
    return(
      <div className='about-container'>
            ...
            <a href="https://github.com/AlexandraMol" add target="_blank" rel="noreferrer"><FaGithub className="icon"></FaGithub></a>
         <FaPhone className="icon">
         </FaPhone>
         <FaMailBulk className="icon"></FaMailBulk>
         <a href="https://www.linkedin.com/in/maria-alexandra-molnar-5682811a4/" add target="_blank" rel="noreferrer"><FaLinkedin className="icon"></FaLinkedin></a>
